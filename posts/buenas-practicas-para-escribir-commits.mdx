---
title: 'buenas practicas para escrbir commits en git'
description: 'tutorial for learning to writting commits to git'
image: 'git'
date: '14/03/2024'
---
...
![¿Quién no se ha encontrado con un historial de commits así? Fuente: xkcd.com" ](https://imgs.xkcd.com/comics/git_commit_2x.png)
